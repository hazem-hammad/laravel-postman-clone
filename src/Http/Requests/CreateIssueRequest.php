...
class CreateIssueRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'context' => ['array'],
            'context.collection_name' => ['nullable', 'string'],
            'context.request_path' => ['nullable', 'string'],
            'context.method' => ['nullable', 'string'],
            'context.url_raw' => ['nullable', 'string'],
            'context.url_resolved' => ['nullable', 'string'],
